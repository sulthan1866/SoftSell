  ...
  const features = [
    {
      ...
      description:
        "Get real-time license valuations based on current market trends using our AI-powered pricing engine.",
      icon: Gauge,
    ...
    },
    {
      title: "Fast Payments",
      description:
        "Receive your payment within 24 hours of license approval with multiple payout options available.",
      icon: Wallet,
    ...
    },
    {
      ...
      description:
        "We ensure safe and legal transfer of software licenses with proper documentation and verification.",
      icon: ShieldCheck,
    ...
    },
    {
      title: "24/7 Support",
      description:
        "Our support team is always ready to help you through the process with expert guidance.",
      icon: Headphones,
            ...
            ({
              ...
              >
                <div className="p-6 md:p-8 h-full border border-gray-200 dark:border-gray-700 rounded-2xl bg-white dark:bg-gray-800 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                  <div
                    className={`${color} ${textColor} w-14 h-14 flex items-center justify-center rounded-full mb-6`}
                  >
