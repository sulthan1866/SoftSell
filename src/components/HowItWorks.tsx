...
const HowItWorks = () => {
  const steps = [
    ...
    { 
      ...
      description: "Our AI-powered system analyzes the market and provides you with a competitive valuation within minutes.",
      color: "bg-green-500"
    },
    { 
      title: "Get Paid", 
      icon: <CreditCard className="w-8 h-8" />,
      description: "Accept the offer and receive payment directly to your bank account or preferred payment method.",
      color: "bg-purple-500"
    },
  ];
    ...
    <section className="py-20 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6">How SoftSell Works</h2>
            ...
            {steps.map((step, idx) => (
              ...
              >
                <div className="p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100 dark:border-gray-700 h-full">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-center mb-4">{step.description}</p>
        ...
        >
          ...
          <div className="space-y-4">
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg">
              <h4 className="font-medium text-blue-600 dark:text-blue-400 mb-2">What types of licenses can I sell?</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">We accept most enterprise software licenses, including Adobe, Microsoft, Autodesk, and many more.</p>
            </div>
            
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg">
              <h4 className="font-medium text-blue-600 dark:text-blue-400 mb-2">How quickly will I receive payment?</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Most sellers receive payment within 48 hours of license verification.</p>
            </div>
            
            <div className="p-4 bg-white dark:bg-gray-800 rounded-lg">
              <h4 className="font-medium text-blue-600 dark:text-blue-400 mb-2">Is the process secure?</h4>
              <p className="text-gray-600 dark:text-gray-400 text-sm">Absolutely. We use bank-level encryption and never store your license keys on our servers.</p>
            </div>
          </div>
